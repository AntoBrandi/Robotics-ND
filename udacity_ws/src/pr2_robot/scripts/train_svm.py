...
training_set = pickle.load(open('/home/omncbar/Robotics-ND/udacity_ws/training_set_3.sav', 'rb'))
...
pickle.dump(model, open('/home/omncbar/Robotics-ND/udacity_ws/model_3.sav', 'wb'))
